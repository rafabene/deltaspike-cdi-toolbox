...
public class MyJSFBean {
    ...
    @Inject private [highlight]#JsfMessage<Messages> messages#;
    //@Inject private Messages msg;

    //getFacesContext().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, msg.welcomeToDeltaSpike(), null));
